        ...
        <div class="xp-sidebar">
            ...
            <div class="xp-navigationbar">
                <ul class="xp-vertical-menu">
                    ...
                    <li>
                        <a href="<?= url('karyawan') ?>">
                            <i class="dripicons-user-group"></i><span>Karyawan</span>
                        </a>
                    </li>
                    <li>
        ...
        <div class="xp-breadcrumbbar">
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <h4 class="xp-page-title">Absen</h4>
                </div>
                ...
                <div class="sidebar">
                    ...
                    <section class="scans">
                        ...
                        <transition-group name="scans" tag="ul">
                            ...
                            <a :href="'<?= url('/absen/apel').'/' ?>'+scan.content" v-for="scan in scans" :key="scan.date" :title="scan.content"><button>Absen</button></a>
                            <!--                </form>-->
                        </transition-group>
                    </section>
                </div>
...
<!-- Datatable init JS -->
<script src="<?= url('/') ?>/assets/js/init/table-datatable-init.js"></script>
