                        ...
                        <div class="card-body">
                            <section class="scans">
                                ...
                                <transition-group name="scans" tag="ul">
                                    ...
                                    <a :href="'<?= url('/absen/pagi').'/' ?>'+scan.content" v-for="scan in scans" :key="scan.date" :title="scan.content"><button class="btn btn-success form-control">Absen</button></a>
                                    <!--                </form>-->
                                </transition-group>
                            </section>
                        </div>
